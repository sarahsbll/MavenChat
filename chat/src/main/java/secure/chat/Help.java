...
public class Help {
	...
	/**
	 * check for matching byte[] and string conver the toBeCheck into string first
	 * then check with template
	 * 
	...
	/**
	 * look for serverCipher within receivedCipher if serverCipher not found, throw
	 * ErrorException
	 * 
	 ...
	 * 
	 * @param combined is the byte[] of combination of command and base64 encoded
	 *                 string
